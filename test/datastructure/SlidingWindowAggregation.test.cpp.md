...
data:
  ...
  bundledCode: "#line 1 \"test/datastructure/SlidingWindowAggregation.test.cpp\"\n\
...
layout: document
redirect_from:
- /verify/test/datastructure/SlidingWindowAggregation.test.cpp
- /verify/test/datastructure/SlidingWindowAggregation.test.cpp.html
