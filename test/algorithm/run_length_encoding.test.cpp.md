...
data:
  ...
  bundledCode: "#line 1 \"test/algorithm/run_length_encoding.test.cpp\"\n#define PROBLEM\
    ...
    \ 4 \"test/algorithm/run_length_encoding.test.cpp\"\n\nint main() {\n    STR(S);\n\
  ...
  dependsOn:
  - other/template.hpp
  - algorithm/run_length_encoding.hpp
...
layout: document
redirect_from:
- /verify/test/algorithm/run_length_encoding.test.cpp
- /verify/test/algorithm/run_length_encoding.test.cpp.html
